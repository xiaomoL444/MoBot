...
namespace BilibiliLive.Handle.Stream
{
	public class StartLiveHandle : IMessageHandle<Group>
	{
		...
		public string Name => "开始推流";

		public string Description => "/开始推流";

		public Task<bool> CanHandleAsync(Group message)
		{
			if (message.IsGroupID(Constants.OPGroupID) && message.IsUserID(Constants.OPAdmin) && message.IsMsg("/开始推流"))
		...
		public async Task HandleAsync(Group message)
		{
			...
			await LiveManager.StartLive(sendMessage);
		}
	}
}
